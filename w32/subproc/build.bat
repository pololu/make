...
set cflags=-mthreads -Wall -I.. -I. -I../include -I../.. -DWINDOWS32 %configflags%

gcc %cflags% -c misc.c -o ../../w32_misc.o
gcc %cflags% -c sub_proc.c -o ../../sub_proc.o
gcc %cflags% -c w32err.c -o ../../w32err.o
:BuildEnd
